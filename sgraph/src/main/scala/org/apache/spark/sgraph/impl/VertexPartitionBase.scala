...
private[sgraph] object VertexPartitionBase {
  /**
 ...
 */
private[sgraph] abstract class VertexPartitionBase[@specialized(Long, Int, Double) VD: ClassTag]
 ...
 */
private[sgraph] trait VertexPartitionBaseOpsConstructor[T[X] <: VertexPartitionBase[X]] {
